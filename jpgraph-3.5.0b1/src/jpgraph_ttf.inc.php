...
class TTF {
    ...
    function __construct() {
	    ...
	    FF_COMIC =>   array(FS_NORMAL =>'comic.ttf',
	    	...
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),
	    FF_ARIAL =>   array(FS_NORMAL =>'msttcorefonts/arial.ttf',
	    	FS_BOLD  =>'msttcorefonts/arialbd.ttf',
	    	FS_ITALIC =>'msttcorefonts/ariali.ttf',
	    	FS_BOLDITALIC =>'msttcorefonts/arialbi.ttf' ) ,
